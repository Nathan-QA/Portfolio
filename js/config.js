...
export const I = {
  fr:{
    ...
    hero_desc:"J’ai travaillé sur la QA de Dordogne, la production de PYLA et le level design de Distant Shore : Bretagne et Long Time A Girl",
  ...
  en:{
    ...
    hero_desc:"I’ve worked on QA for Dordogne, production for PYLA, and level design for Distant Shore: Bretagne and Long Time A Girl",
