...
export const I = {
  fr:{
    ...
    author_welcome:"Bienvenue, moi c’est Nathan",
    author_roles:"Production · QA · Level Design",
    author_place:"Bordeaux, France",
    author_farewell:"Merci d’être passé",
    hero_desc:"J’accompagne les équipes dans la fabrication de leurs jeux, du suivi de production aux tests, jusqu’au travail dans le moteur",
    ...
    projects_title:"Les jeux",cases_title:"Études de cas",
    about_role_title:"Compétences",about_skills_title:"Compétences",
    contact_title:"Faisons connaissance",legal_title:"Mentions légales",
  ...
  en:{
    ...
    author_welcome:"Hello, I’m Nathan",
    author_roles:"Production · QA · Level Design",
    author_place:"Bordeaux, France",
    author_farewell:"Thanks for stopping by",
    hero_desc:"I work alongside teams as they make their games, from production planning and testing to hands-on work in the engine",
    ...
    projects_title:"The games",cases_title:"Case studies",
    about_role_title:"Skills",about_skills_title:"Skills",
    contact_title:"Let’s talk",legal_title:"Legal notice",
