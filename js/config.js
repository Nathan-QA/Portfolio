...
export const PROFILE = {
  tagline: {
    fr: "Production, QA et Level Design. Coordination d’équipe, suivi des builds et travail dans le moteur.",
    en: "Production, QA and Level Design. Team coordination, build tracking and hands-on engine work."
  },
...
export const I = {
  fr:{
    ...
    nav_projects:"Projets",nav_cases:"Études de cas",nav_about:"Compétences",nav_contact:"Contact",
    cv_fr:"CV FR",cv_en:"CV EN",hero_kicker:"Jeu vidéo · Bordeaux",
    hero_title:"Nathan Tandille",
    hero_roles:"Production · QA · Level Design",
    hero_focus_label:"Production",
    hero_focus_value:"Planning, scope et budget\nCoordination et suivi d’équipe\nDossiers de financement",
    hero_scope_label:"QA",
    hero_scope_value:"Plans de test et suivi des anomalies\nCoordination QA interne et externe\nBuilds, certification et livraison",
    hero_tools_label:"Level Design",
    hero_tools_value:"Blockout et intégration Unity\nGuidage, rythme et parcours\nPlaytests et itérations",
    hero_desc:"Je travaille sur les jeux et avec les équipes qui les font, de l’organisation de la production aux tests et au level design",
    projects_note:"Jeux & collaborations",cases_note:"Notes de développement",about_note:"Du travail, et une façon de le faire",atelier_contact_note:"La suite commence par un échange",footer_note:"Merci de votre visite",
    ...
    contact_title:"Contact",legal_title:"Mentions légales",
  ...
  en:{
    ...
    cv_fr:"CV FR",cv_en:"CV EN",hero_kicker:"Game development · Bordeaux",
    hero_title:"Nathan Tandille",
    hero_roles:"Production · QA · Level Design",
    hero_focus_label:"Production",
    hero_focus_value:"Scheduling, scope and budget\nTeam coordination and task tracking\nFunding applications",
    hero_scope_label:"QA",
    hero_scope_value:"Test plans and issue tracking\nInternal and external QA coordination\nBuilds, certification and release",
    hero_tools_label:"Level Design",
    hero_tools_value:"Blockout and Unity integration\nGuidance, pacing and navigation\nPlaytesting and iteration",
    hero_desc:"I work on games and with the people who make them, from organising production to testing and level design",
    projects_note:"Games & collaborations",cases_note:"Development notes",about_note:"The work, and how I approach it",atelier_contact_note:"The next step starts with a conversation",footer_note:"Thank you for stopping by",
    ...
    timeline_uma_time:"Aug. 2022 - Sep. 2023",
    timeline_uma_title:"UMANIMATION - Dordogne",
    timeline_uma_text:"QA internship, fixed-term QA Manager, then QA Producer: builds, tickets, certification and release.",
    timeline_ltag_time:"Oct. 2023 - Mar. 2025",
    timeline_ltag_title:"UMANIMATION - Long Time a Girl",
    timeline_ltag_text:"Level Designer & Assistant Game Designer, areas, documentation, integration and design follow-up.",
    ...
    contact_title:"Contact",legal_title:"Legal notice",
