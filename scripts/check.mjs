...
const baseline={
 ...
 'js/config.js':'eb24325d23c38aca88ba7f2682fb1ff81caacbba',
...
for(const path of ['js/main.js','js/ux.js','js/router.js','ux.css'])await readFile(path);
...
console.log(`PASS: original stylesheet, theme config, 6 scenery assets and curtain/particle implementation unchanged; ${count} bilingual contents validated`);
